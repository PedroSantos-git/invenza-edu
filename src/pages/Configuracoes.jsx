...
const TEMPLATE_VARS = {
  ...
  DEVOLUCAO_DOCENTE: ['{{equipamento}}', '{{pessoa}}', '{{numero_docente}}', '{{data_devolucao}}', '{{estado_equipamento}}', '{{acessorios_devolvidos}}', '{{notas}}', '{{data_hoje}}', '{{uuid}}', '{%barcode_serie}', '{%barcode_imobilizado}', '{{kit_count}}', '{{kit_items}}', '{{data_hora}}', '{{nome_docente}}', '{{nif_docente}}', '{{equipamento_secoes}}', '{{equipamento_secao_a}}', '{{equipamento_secao_b}}', '{{utilizador_atual}}', '{{docente_grupo_recrutamento}}', '{{docente_qe}}', '{{docente_cc_numero}}'],
