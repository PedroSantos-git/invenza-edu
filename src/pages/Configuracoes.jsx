...
const TEMPLATE_VARS = {
  EMPRESTIMO_ALUNO: ['[[equipamento]]', '[[pessoa]]', '[[numero_aluno]]', '[[data_emprestimo]]', '[[acessorios]]', '[[notas_entrega]]', '[[data_hoje]]', '[[uuid]]', '[%barcode_serie]', '[%barcode_imobilizado]', '[[kit_count]]', '[[kit_items]]', '[[data_hora]]', '[[ee_nome]]', '[[ee_nif]]', '[[nome_aluno]]', '[[nif_aluno]]', '[[numero_processo_aluno]]', '[[turma_aluno]]', '[[equipamento_secoes]]', '[[equipamento_secao_a]]', '[[equipamento_secao_b]]', '[[cabecalho_entrega]]', '[[utilizador_atual]]'],
  EMPRESTIMO_DOCENTE: ['[[equipamento]]', '[[pessoa]]', '[[numero_docente]]', '[[data_emprestimo]]', '[[acessorios]]', '[[notas_entrega]]', '[[data_hoje]]', '[[uuid]]', '[%barcode_serie]', '[%barcode_imobilizado]', '[[kit_count]]', '[[kit_items]]', '[[data_hora]]', '[[nome_docente]]', '[[nif_docente]]', '[[equipamento_secoes]]', '[[equipamento_secao_a]]', '[[equipamento_secao_b]]', '[[cabecalho_entrega]]', '[[utilizador_atual]]', '[[docente_grupo_recrutamento]]', '[[docente_qe]]', '[[docente_cc_numero]]'],
  DEVOLUCAO_ALUNO: ['[[equipamento]]', '[[pessoa]]', '[[numero_aluno]]', '[[data_devolucao]]', '[[estado_equipamento]]', '[[acessorios_devolvidos]]', '[[notas]]', '[[data_hoje]]', '[[uuid]]', '[%barcode_serie]', '[%barcode_imobilizado]', '[[kit_count]]', '[[kit_items]]', '[[data_hora]]', '[[ee_nome]]', '[[ee_nif]]', '[[ee_cc]]', '[[nome_aluno]]', '[[nif_aluno]]', '[[numero_processo_aluno]]', '[[turma_aluno]]', '[[morada_pessoa]]', '[[cc_pessoa]]', '[[equipamento_secoes]]', '[[equipamento_secao_a]]', '[[equipamento_secao_b]]', '[[cabecalho_devolucao]]', '[[utilizador_atual]]'],
  DEVOLUCAO_DOCENTE: ['[[equipamento]]', '[[pessoa]]', '[[numero_docente]]', '[[data_devolucao]]', '[[estado_equipamento]]', '[[acessorios_devolvidos]]', '[[notas]]', '[[data_hoje]]', '[[uuid]]', '[%barcode_serie]', '[%barcode_imobilizado]', '[[kit_count]]', '[[kit_items]]', '[[data_hora]]', '[[nome_docente]]', '[[nif_docente]]', '[[morada_pessoa]]', '[[cc_pessoa]]', '[[equipamento_secoes]]', '[[equipamento_secao_a]]', '[[equipamento_secao_b]]', '[[cabecalho_devolucao]]', '[[utilizador_atual]]', '[[docente_grupo_recrutamento]]', '[[docente_qe]]', '[[docente_cc_numero]]'],
  AVARIA: ['[[equipamento]]', '[[pessoa]]', '[[numero_pessoa]]', '[[estado]]', '[[origem]]', '[[diagnostico]]', '[[resolucao]]', '[[componentes]]', '[[data_registo]]', '[[data_resolucao]]', '[[data_hoje]]', '[[uuid]]', '[%barcode_serie]', '[%barcode_imobilizado]', '[[kit_count]]', '[[kit_items]]', '[[data_hora]]', '[[equipamento_secoes]]', '[[equipamento_secao_a]]', '[[equipamento_secao_b]]', '[[utilizador_atual]]'],
  EQUIPAMENTO: ['[[designacao]]', '[[numero_serie]]', '[[numero_imobilizado]]', '[[tipo]]', '[[marca]]', '[[modelo]]', '[[estado]]', '[[data_entrada]]', '[[notas]]', '[[data_hoje]]', '[[uuid]]', '[%barcode_serie]', '[%barcode_imobilizado]', '[[kit_count]]', '[[kit_items]]', '[[data_hora]]', '[[equipamento_secoes]]', '[[equipamento_secao_a]]', '[[equipamento_secao_b]]', '[[utilizador_atual]]'],
};
